...
Select the link to learn more about [**tibbles**](https://tibble.tidyverse.org/).
...
Select the link to view the nominal GDP series: [**Nominal GDP**](https://fred.stlouisfed.org/series/GDP)
