...
Like the code above, since we are only clearing memory and loading packages, there is no significant output other than we are preparing for the work to come.
