...
We can use the **pnorm** function in area with **lower.tail = TRUE** to
estimate, for a standard normal distribution, the probability that Z is
less than or equal to 1.53. We can also estimate the probability of Z
being greater than 1.53 using the **lower.tail = FALSE** option.
...
inches is 0.05 (or 95% of students have heights 75 inches and less).
