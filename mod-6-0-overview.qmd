...
-   MLO 1: **Differentiate** between discrete and continuous random variables and describe the role of probability density functions.

-   MLO 2: **Compute** and interpret probabilities using the uniform, normal, and exponential distributions.

-   MLO 3: **Apply** R functions (dnorm, pnorm, qnorm, dunif, punif, pexp) to calculate and visualize probability densities and cumulative distributions.

-   MLO 4: **Explain** the properties of the normal distribution and the Central Limit Theorem.

-   MLO 5: **Calculate** expected values, variances, and probabilities for continuous random variables.

-   MLO 6: **Evaluate** real-world examples that demonstrate how continuous distributions model random events such as arrival times, measurement variation, and economic outcomes.
