...
For example, **library(dplyr)** loads the dplyr package so we can use its functions later in our code.

Note, however, the code below is ***static***. In other words, you can't run the code here. You will have to replicate the code in your RStudio. 
